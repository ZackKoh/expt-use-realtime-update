...
The problem: I want to receive a stream of IOT updates from the backend, to update a time series chart. However, it causes the chart to go into an infinite re-render cycle.

Now I would like to return to the problem, and see if the hypothesis I have can be used to avoid the infinite re-render issue.

This is the intended way the hook is supposed to work:
- It should be able to display a list of values from the API call
